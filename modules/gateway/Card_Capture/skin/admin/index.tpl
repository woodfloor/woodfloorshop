...
<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
	<div id="Card_Capture" class="tab_content">
  		...
  		<fieldset><legend>{$LANG.card_capture.title_config_basic}</legend>
    		...
    		<div><label for="go_processing">{$LANG.card_capture.go_processing}</label><span><input type="hidden" name="module[go_processing]" id="go_processing" class="toggle" value="{$MODULE.go_processing}" /></span></div>
